...
# Substitute: halite, coworld-halite, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-halite:ci)
#   SMOKE_SLUG                 game slug                        (halite)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/halite)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/halite-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-halite:ci}}"
slug="${SMOKE_SLUG:-halite}"
